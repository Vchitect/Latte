...
- (🔥 New) Jan. 9, 2024. 💥 A LatteT2V model initialized with the [PixArt-α](https://github.com/PixArt-alpha/PixArt-alpha) weights is released. The model weight can be founed [here](https://huggingface.co/maxin-cn/Latte/resolve/main/t2v.pt?download=true).
