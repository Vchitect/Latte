...
- (🔥 New) **May 23, 2024** 💥
  ...
  **Latte-1** is released! Pre-trained model can be downloaded [here](https://huggingface.co/maxin-cn/LatteT2V/tree/main/transformer_v1). We support both T2V and T2I. Please run `bash sample/t2v.sh` and `bash sample/t2i.sh` respectively.
